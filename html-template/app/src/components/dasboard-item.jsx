...
export const DasboardItem = ({logo, title, token, secret, status, }) => {

  return (
    <div className='px-16 mb-10 shadow-lg rounded-[10px] py-[2.5rem] w-full bg-white dark:bg-darkmode-black-02 flex justify-between items-center' >
        ...
        <div>
            <button className='bg-pink px-2 py-2 rounded-[10px] mr-12'><BiTrash className='text-white' /></button>
