    ...
    <div style={view ?{display: 'flex'}:{display: 'none'}} className='justify-end bg-black-transparent z-50 absolute top-0 bottom-0 left-0 right-0 m-[0 auto]' >
        <div className='bg-[#ffffff] dark:bg-darkmode-black-02 w-[40rem] h-full px-16 py-12' >
            ...
            <div className='flex' >
                ...
                <div>
                    <input className='dark:focus-visible:outline-none dark:bg-darkmode-black-02 dark:text-[#ffffff] focus-visible:outline-none mb-[.4rem] border-b border-b-gray-border' type="text" placeholder='Nombre de la app' />
             ...
             validate={values => {
                ...
                {({values}) => (
                    ...
                    <div className='relative flex flex-col w-full' >
                        ...
                        <Field name='secret' className='dark:focus-visible:outline-none focus-visible:outline-none dark:bg-darkmode-black-02 dark:text-[#ffffff] rounded px-3 py-2 focus:dark:bg-darkmode-black-02  mb-8 border-2 border-gray-light' id='secret' type="password" />
